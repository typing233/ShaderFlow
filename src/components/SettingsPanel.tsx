...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative w-full max-w-lg mx-4 bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl transition-transform duration-200',
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  从 <a href="https://platform.deepseek.com/" target="_blank" rel="noopener noreferrer" className="text-shader-400 hover:text-shader-300 underline">Deepseek 平台</a> 获取 API Key
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 text-sm text-gray-200 bg-gray-800 border border-gray-700 rounded-xl focus:outline-none focus:border-shader-500 transition-colors appearance-none cursor-pointer"
                >
